            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-5">
                <form method="POST" action="/post/{{ $post->id }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group pt-4">
                        ...
                        <select name="cuisine_id" value="{{ $post->cuisine_id }}"
                        ...
                        focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none">
                            ...
                            @foreach ($cuisine as $cuisineItem)
                                <option value="{{ $cuisineItem->id }}"
                                    {{ $post->cuisine_id == $cuisineItem->id ? 'selected' : '' }}>
                                    {{ $cuisineItem->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group pt-4">
                        ...
                        focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                            name="ingredients" rows="10" placeholder="- 2 eggs ...">
                            {!! $post->ingredients !!}
                        </textarea>
                    ...
                    <div class="form-group pt-4">
                        ...
                        transition ease-in-out m-0
                        focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                            name="steps" rows="10" placeholder="- Cook the rice ...">
                            {!! $post->steps !!}
                        </textarea>
                    ...
                    <div class="form-group pt-4">
                        ...
                        <div class="flex">
                            <div class="mr-2">
                                <input type="number" name="ct_hrs" min="1" max="24" value="{{ $post->ct_hrs }}"
                            ...
                            <div>
                                <input type="number" name="ct_min" min="1" max="59" value="{{ $post->ct_min }}"
                                    class="bg-gray-100 rounded border border-gray-400 leading-normal resize-none w-15 h-10 py-2 px-3 font-medium placeholder-gray-700 focus:outline-none focus:bg-white">
                                min
                            </div>
                        </div>
